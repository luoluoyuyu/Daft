...
class LogicalPlanBuilder:
    @staticmethod
    def from_bytes(bytes: builtins.bytes) -> LogicalPlanBuilder: ...
    def to_bytes(self) -> builtins.bytes: ...
    def contains_python_udf(self) -> builtins.bool: ...
...
class DistributedPhysicalPlan:
    ...
    @staticmethod
    def from_compiled_logical_plan(
        compiled_plan: CompiledLogicalPlan, query_id: str, config: PyDaftExecutionConfig
    ) -> DistributedPhysicalPlan: ...
    def idx(self) -> str: ...
    def num_partitions(self) -> int: ...
    def repr_ascii(self, simple: bool) -> str: ...
    def repr_mermaid(self, options: MermaidOptions) -> str: ...
    def repr_json(self, psets: dict | None = None) -> str: ...
...
class LocalPhysicalPlan:
    ...
    @staticmethod
    def from_compiled_logical_plan(
        compiled_plan: CompiledLogicalPlan,
        psets: dict[str, list[PyMicroPartition]],
    ) -> tuple[LocalPhysicalPlan, dict[int, Input]]: ...
